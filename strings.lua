...
- As of February 2024, some more constructions can be moved. If you plopped them before the update, bulldoze them and rebuild them to make them moveable.
			]],
            ...
            ["Up"] = "Up",
            ["West"] = "West",
            ["Note"] = " - North, West, South and East are relative to your current screen orientation. \n - Constructions with bits of road may require readjusting those roads. The splits could be invisible and annoying to handle. \nTo make life easier, those constructions should give the option of snapping roads to their neighbours (like depots), and you should use it. \nThe street fine tuning (merges, tight bends, chunks) and the freestyle station (stairs, lifts, platform as assets, fences) can handle this well. \n - As of February 2024, some more constructions can be moved. If you plopped them before the update, bulldoze them and rebuild them to make them moveable.",
        },
    }
end
