...
- Constructions with bits of road may require readjusting those roads. The splits could be invisible and annoying to handle. To make life easier, those constructions should give the option of snapping roads to their neighbours (like depots), and you should use it. The street fine tuning (merges, tight bends, chunks) and the freestyle station (stairs, lifts) can handle this well.
            ...
            ["Up"] = "Up",
            ["West"] = "West",
            ["Note"] = "Constructions with bits of road may require readjusting those roads. The splits could be invisible and annoying to handle. \n To make life easier, those constructions should give the option of snapping roads to their neighbours (like depots), and you should use it. \n The street fine tuning (merges, tight bends, chunks) and the freestyle station (stairs, lifts) can handle this well, unless you purposedly unsnap a construction after building it.",
        },
    }
end
