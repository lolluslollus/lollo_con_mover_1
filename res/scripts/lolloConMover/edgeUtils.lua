...
local matrixUtils = require('lolloConMover.matrix')
local quadrangleUtils = require('lolloConMover.quadrangleUtils')
...
helper.track.getNearestEdgeIdStrict = function(transf)
    ...
    --     return baseEdgeIds[1]
        ...
        --     end
        -- end
        print('lolloConMover WARNING track.getNearestEdgeIdStrict falling back')
        return baseEdgeIds[1] -- fallback
    end
end
